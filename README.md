...
Программы моделируют одну ночь работы гостиницы.
...
Требования, совпадающие с требованиями на более низкую оценку, остались выполненными и в [этой](https://github.com/kamilarakhimova/hse-os-hw3/tree/main/6-7%20баллов) программе.
